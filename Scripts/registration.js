...
const get_elems = async () => {
    // Hardcoded data for colleges and sports
  
    let sport_list_json = {
      data: [
        { name: "Badminton", sport_id: 1 },
        { name: "Cricket", sport_id: 2 },
        { name: "Football", sport_id: 3 },
        { name: "Volleyball", sport_id: 4 },
        { name: "Basketball", sport_id: 5 },
        { name: "Chess", sport_id: 6 },
        { name: "Carrom", sport_id: 7 },
        { name: "Table Tennis", sport_id: 8 },
        { name: "Kabaddi", sport_id: 9 },
      ],
    };

    avail_sports = sport_list_json.data;
